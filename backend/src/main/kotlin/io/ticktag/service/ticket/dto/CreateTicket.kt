...
data class CreateTicket(
    ...
    constructor(req: CreateTicketRequestJson) : this(
            ...
            req.currentEstimatedTime, req.dueDate, req.description, req.projectId, req.ticketAssignments.map(::TicketAssignment), req.subTickets?.map(::CreateTicket), req.existingSubTicketIds, req.parentTicketId)
