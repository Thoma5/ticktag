...
class TicketResultJson(
        ...
        val projectId: UUID,
        val tickerUserRelations: List<TickerUserRelationResultJson>,
    ...
    constructor(t: TicketResult) : this(id = t.id, number = t.number, createTime = t.createTime, title = t.title,
            ...
            projectId = t.projectId, tickerUserRelations = t.ticketAssignments.map(::TickerUserRelationResultJson),
