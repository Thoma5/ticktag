...
open class RestSecurityConfigBeans {
    ...
    @Bean("restAuthFilter")
    open fun restAuthFilter(@Named("restAuthTokenService") tokenService: TokenService, users: UserRepository, members: MemberRepository, comments: CommentRepository, assignmentTags: AssignmentTagRepository, loggedTimes: LoggedTimeRepository): Filter {
