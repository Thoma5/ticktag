...
export class TicketeventApi {
     ...
     */
    public listTicketEventsUsingGET(ticketId: string, extraHttpRequestParams?: any): Observable<Array<models.TicketEventResultJson>> {
        return this.listTicketEventsUsingGETWithHttpInfo(ticketId, extraHttpRequestParams)
     ...
     * @param ticketId ticketId
     */
    public listTicketEventsUsingGETWithHttpInfo(ticketId: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/ticketevent`;

        let queryParameters = new URLSearchParams();
        let headers = new Headers(this.defaultHeaders.toJSON()); // https://github.com/angular/angular/issues/6845
        // verify required parameter 'ticketId' is not null or undefined
        if (ticketId === null || ticketId === undefined) {
            throw new Error('Required parameter ticketId was null or undefined when calling listTicketEventsUsingGET.');
        }
