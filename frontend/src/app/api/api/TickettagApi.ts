...
export class TickettagApi {
     ...
     * listTicketTags
     * 
     * @param ticketTagGroupId ticketTagGroupId
     * @param projectId projectId
     */
    public listTicketTagsUsingGET(ticketTagGroupId?: string, projectId?: string, extraHttpRequestParams?: any): Observable<Array<models.TicketTagResultJson>> {
        return this.listTicketTagsUsingGETWithHttpInfo(ticketTagGroupId, projectId, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param projectId projectId
     */
    public listTicketTagsUsingGETWithHttpInfo(ticketTagGroupId?: string, projectId?: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/tickettag/`;

        let queryParameters = new URLSearchParams();
        let headers = new Headers(this.defaultHeaders.toJSON()); // https://github.com/angular/angular/issues/6845
        if (ticketTagGroupId !== undefined) {
            queryParameters.set('ticketTagGroupId', <any>ticketTagGroupId);
        }
