...
export class TicketApi {
     ...
     * @param id id
     */
    public listCommentsUsingGET1(id: string, extraHttpRequestParams?: any): Observable<Array<models.CommentResultJson>> {
        return this.listCommentsUsingGET1WithHttpInfo(id, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param id id
     */
    public listCommentsUsingGET1WithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/ticket/${id}/comments`;

        let queryParameters = new URLSearchParams();
        let headers = new Headers(this.defaultHeaders.toJSON()); // https://github.com/angular/angular/issues/6845
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling listCommentsUsingGET1.');
        }
