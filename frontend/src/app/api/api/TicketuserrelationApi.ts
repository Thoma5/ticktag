...
@Injectable()
export class TicketuserrelationApi {
     ...
     * @param userId userId
     */
    public createTicketAssignmentUsingPOST(ticketId: string, assignmentTagId: string, userId: string, extraHttpRequestParams?: any): Observable<models.TicketUserRelationResultJson> {
     ...
     * @param userId userId
     */
    public getTicketAssignmentUsingGET(ticketId: string, assignmentTagId: string, userId: string, extraHttpRequestParams?: any): Observable<models.TicketUserRelationResultJson> {
    ...
    public createTicketAssignmentUsingPOSTWithHttpInfo(ticketId: string, assignmentTagId: string, userId: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/ticket/${ticketId}/assignmenttag/${assignmentTagId}/user/${userId}`;
