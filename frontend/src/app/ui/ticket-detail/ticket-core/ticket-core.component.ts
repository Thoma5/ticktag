...
import { TicketDetailTag, TicketDetailUser } from '../ticket-detail';
...
export class TicketCoreComponent implements OnChanges {
    ...
    @Input() tags: imm.List<TicketDetailTag>;
    private tagIds: imm.List<string>;  // generated by tags
    ...
    ngOnChanges(changes: SimpleChanges): void {
      if ('tags' in changes) {
        this.tagIds = this.tags.map(tag => tag.id).toList();
      }
    }
}
