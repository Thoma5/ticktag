...
java -jar swagger-codegen-cli.jar generate -i "http://localhost:8080/v2/api-docs" -l "typescript-angular2" -o ./api_new && (rm -r src/app/api || true) && mv ./api_new src/app/api
